...
namespace BL.Servicer.Maps.Bing
{
    public abstract class Primitive : IPrimitive
    {
        ...
        public BL.Servicer.MapCore.Location Location
        {
            ...
            set
            {
                if (value != null && value.Latitude == lastLatitude && value.Longitude == lastLongitude)
                {
                    return;
                }
                ...
                this.lastLongitude = this.location.Longitude;
                this.lastLatitude = this.location.Latitude;
